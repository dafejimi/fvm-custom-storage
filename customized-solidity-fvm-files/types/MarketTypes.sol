...
library MarketTypes {
    ...
    struct PublishCustomStorageDealsParams {
        ClientCustomDealProposal[] customDeals;
    }

    struct PublishCustomStorageDealsReturn {
        CommonTypes.FilActorId[] ids;
        bytes valid_deals;
    }
    ...
    struct ClientCustomDealProposal {
        CustomDealProposal proposal;
        bytes client_signature;
    }
    ...
    struct MarketCustomDealNotifyParams {
        bytes customDealProposal;
        uint64 dealId;
    }

    struct CustomDealProposal {
        CommonTypes.Cid piece_cid;
        uint64 piece_size;
        bool verified_deal;
        CommonTypes.FilAddress client;
